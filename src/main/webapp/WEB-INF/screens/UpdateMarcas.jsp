...
<div class="container">
    <%Marcas marcas = (Marcas) request.getAttribute("aMarcas");%>
    <form action="<%=context%>/ServletAgregarMarcas" method="post">
        <div class="row">
            <div class="col text-center">
                <label class="" for="" > Nombre </label>
                <input type="text" id="Marca_del_producto" name="Marca_del_producto" value="<%=marcas.getMarca_del_producto()%>" class="form-control" placeholder="First name">
            </div>
